...
O inglês é o idioma canónico da documentação do repositório. As versões PT-BR e PT-PT são mantidas como referências localizadas.
...
|-- pages/                    # vistas de negócio multipágina no Streamlit
