...
class DataPreprocessor:
    """Legacy facade kept for compatibility with the canonical bronze/silver pipeline."""
    ...
    def split_data(
        ...
        logger.info("legacy_split_data train_shape=%s test_shape=%s", X_train.shape, X_test.shape)
